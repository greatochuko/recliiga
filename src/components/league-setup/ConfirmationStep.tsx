...
export function ConfirmationStep({ leagueData }) {
  return (
    <Card className="mb-8">
      <CardHeader>
        <CardTitle className="text-2xl font-semibold text-center text-gray-800">Confirmation</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            You've successfully set up your {leagueData.sport} league. Get ready for an exciting season!
          </p>
        </div>
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
            <div>
              ...
              <dd className="mt-1 text-sm text-gray-900">{leagueData.leagueName}</dd>
            </div>
            <div>
            ...
            <div>
              <dt className="text-sm font-medium text-gray-500">Privacy Setting</dt>
              <dd className="mt-1 text-sm text-gray-900 capitalize">{leagueData.privacySetting}</dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-gray-500">Total Events</dt>
              <dd className="mt-1 text-sm text-gray-900">{leagueData.events.length}</dd>
            </div>
          </dl>
        </div>
