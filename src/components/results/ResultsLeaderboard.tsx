...
export const ResultsLeaderboard = ({
  ...
  return (
    <div className="container mx-auto px-4">
      <h2 className="mb-6 text-2xl font-bold">Results Leaderboard</h2>
      <Card>
              ...
              <TableBody>
                {leagueData.leaderboardData.map((player) => (
                  <TableRow key={player.rank}>
                    ...
                    <TableCell>
                      <div
                        className="hover:text-accent-orange flex cursor-pointer items-center transition-colors"
