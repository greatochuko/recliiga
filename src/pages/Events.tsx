...
function EventsContent() {
  ...
  const pastEvents = [
    ...
    },
    {
      ...
      team1: { name: 'Gunners', avatar: '/placeholder.svg?height=64&width=64', color: '#EF0107' },
      team2: { name: 'Hammers', avatar: '/placeholder.svg?height=64&width=64', color: '#7A263A' },
      status: 'past',
      league: 'Premier League',
      hasResults: true
    }
      ...
      <section>
        ...
        <div className="space-y-4">
          {pastEvents.map(event => (
            <EventCard key={event.id} event={event} isPastEvent={true} showLeagueName={true} />
          ))}
        </div>
      </section>
    </div>
