...
function RatingDialog({ player, onRatingSubmit }: { player: Player, onRatingSubmit: (id: number) => void }) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 pt-10">
      <div className="flex justify-between items-center mb-4">
        ...
        <Button variant="link" className="text-[#FF7A00] hover:text-[#FF7A00]/90 p-0" onClick={() => navigate('/')}>
          Previous
        </Button>
      </div>
      {players.length > 0 ? (
