...
const NotificationSection = ({
  ...
  return <DropdownMenuLabel className="font-bold">{title}</DropdownMenuLabel>
    {notifications.map((notification, index) => <DropdownMenuItem key={index} className="flex items-center py-2">
            ...
            <Table>
              <TableHeader className="bg-gray-100">
                <TableRow>
                  ...
                  {Object.entries(columnExplanations).map(([abbr, explanation]) => <TableHead key={abbr} className="text-center w-16 relative">
                      <Tooltip>
              ...
              <TableBody>
                {leagueData.leaderboardData.map((player: any) => <TableRow key={player.rank}>
